...
public class ChatRoom extends JFrame implements Runnable {
    ...
    public ChatRoom(Socket socket) throws IOException {
        DrawGUI();
        this.socket = socket;
    ...
    public void DrawGUI() {
        ...
        btnSend.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    outToO.writeUTF("Connect_PC: " + msgField.getText());
                    Room.setText("Connect_PC: " + msgField.getText() + "\n" + Room.getText());
                    msgField.setText("");
                } catch (Exception ex) {
    ...
    public void run() {
        while (true) {
            try {
                ...
                if (cmd.equals("Connected_PC")) {
//                    System.out.println("da nhan dc");
                    Room.setText("Connected_PC:"+msg + "\n" + Room.getText());
                } else {
                    socket.close();
                }
            } catch (Exception e) {
